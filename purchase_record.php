...
$sql1="SELECT * FROM ".$_SESSION['user_name']."pr;";
$result = mysql_query($sql1) or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
print "<table width=500 border=1>\n";
print "<th>SN</th><th>Stock Code</th><th>Stock Name</th><th>Quantity</th><th>Purchase Date</th><th>Purchase Price</th><th>Total Investment</th>";
...
$sql5="SELECT port_qty*port_tradeprice as investment FROM ".$_SESSION['user_name']."pr"." WHERE SN='$SN'";
