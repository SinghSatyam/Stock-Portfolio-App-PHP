...
<p>&nbsp;</p>
<form name="userpass" method="post" action="dbsignup.php">
<table align="center">

	<tr>
      <td width="150">USER NAME:</td>
      <td width="150"><input type="text" name="user_name" id="user_name" /></td>
    </tr>
	...
	<tr>
  	...
  	<tr>
  		 <td>Submit The Details : </td>
     	<td><input type="submit" name="submitbutton" id="submitbutton" value="Sign Up"></td>
  	</tr>
	
	<tr>
		<td>Reset The Details :</td>
		<td><input type="reset" name="resetbutton" id="resetbutton"></td>
	</tr>
