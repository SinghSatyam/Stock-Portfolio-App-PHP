...
<br>
<br>
<a href="watchlist_form.php"><h4 align="center">ADD TO WATCHLIST</h4></a>
<br>
<br>
<center>
<div id="tables">
...
$sql1="SELECT * FROM ".$_SESSION['user_name']."wl;";
$result = mysql_query($sql1) or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);

print "<table width=500 border=1>\n";
print "<th>SN</th><th>Stock Code</th><th>Stock Name</th><th>Current Value</th>";
