...
<br>
<div id="quote1">
<form id="form1" name="form1" method="post" action="sell_check.php">
   <input type="text" name="check_sell" align="middle" size="50" width="30" id="check_sell" />
   <br>
  <input type="submit" name="button" id="button" value="Check For Stock" />
</form>
</div>
</body>
</html>
