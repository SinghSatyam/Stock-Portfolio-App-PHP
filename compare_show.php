...
$comp1=str_replace(" ", "","$_POST[comp1]");
$comp2=str_replace(" ", "","$_POST[comp2]");

$url = "http://quote.yahoo.com/d/quotes.csv?s=".$comp1."&f=nxl1k2pol3t8mwvj3rr7y&e=.csv";
$filesize = 2000;
$handle = fopen($url, "r");
...
$url = "http://quote.yahoo.com/d/quotes.csv?s=".$comp2."&f=nxl1k2pol3t8mwvj3rr7y&e=.csv";
$filesize = 2000;
$handle = fopen($url, "r");
$raw_quote_data = fread($handle, $filesize);
fclose($handle);
