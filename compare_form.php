...
<form name="compare" method="POST" action="compare_show.php">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table style="background-color:#996633" border="0" cellspacing="0" valign="top" align="center">
  <tr>
  	<td align="center"><b>Stock1:</b></td>
  	<td align="center"><b>Stock2:</b></td>
  </tr>
  <tr>
  <td align="center"> <input type="text" name="comp1" /></td>
  <td align="center"> <input type="text" name="comp2" /></td>
  </tr>
  <tr>
		<td colspan="2" align="center"><br /><input type="submit" style="font-size:14pt" name="submitbutton" id="submitbutton" value="Compare Stocks"></td>
	</tr>
</table>
</form>
</body>
