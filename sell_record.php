...
$sql1="SELECT * FROM ".$_SESSION['user_name']."sr;";
$result = mysql_query($sql1)
or die("SELECT Error: ".mysql_error());
$num_rows = mysql_num_rows($result);
print "<table width=500 border=1>\n";
print "<th>SN</th><th>Stock Code</th><th>Stock Name</th><th>Quantity</th><th>Selling Date</th><th>Selling Price</th><th>Total Amount of Stock Sold</th>";
$SN=1;
...
print "\t<td>$field</td>\n";
$sql5="SELECT port_qty*port_sold_price as total FROM ".$_SESSION['user_name']."sr"." WHERE SN='$SN'";
