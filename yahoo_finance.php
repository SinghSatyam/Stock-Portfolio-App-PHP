...
$url = "http://quote.yahoo.com/d/quotes.csv?s=".$stock_list."&f=nxl1k2vm2ohgpw&e=.csv";
$filesize = 2000;
$handle = fopen($url, "r");
$raw_quote_data = fread($handle, $filesize);
fclose($handle);
$_SESSION['port_stcode']=$stock_list;


$quote = explode(",", $raw_quote_data);
$_SESSION['port_name'] = str_replace("\"", "", $quote[0]);
$_SESSION['port_exch']=str_replace("\"", "", $quote[1]);
$_SESSION['port_purchase_price']=str_replace("\"", "", $quote[2]);
$_SESSION['port_changeperc']=str_replace("\"", "", $quote[3]);
$_SESSION['port_voltraded']=str_replace("\"", "", $quote[4]);
$_SESSION['port_daysrange']=str_replace("\"", "", $quote[5]);
$_SESSION['port_openpr']=str_replace("\"", "", $quote[6]);
$_SESSION['port_highpr']=str_replace("\"", "", $quote[7]);
$_SESSION['port_lowpr']=str_replace("\"", "", $quote[8]);
$_SESSION['port_lasttrade']=str_replace("\"", "", $quote[2]);
$_SESSION['port_prvcls']=str_replace("\"", "", $quote[9]);
$_SESSION['port_52week']=str_replace("\"", "", $quote[10]);
echo "Script Name : ".$_SESSION['port_name']."<br>";
echo "Exchange : ".$_SESSION['port_exch']."<br>";
echo "Current Price : ".$_SESSION['port_lasttrade']."<br>";
echo "Price Range : ".$_SESSION['port_52week']."<br>";
